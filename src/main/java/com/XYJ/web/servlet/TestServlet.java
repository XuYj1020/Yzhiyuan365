...
public class TestServlet extends BaseServlet {
    public void huodongtupian(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
...
//                    获取后缀
                    ...
                    //拼接新的文件名
                    String newName ="HDTX"+timeStamp+sname;
...
//                    System.out.println("我是"+jsonString);
    ...
    public void zuzhitupian(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
// 设置编码集(解码)
        request.setCharacterEncoding("UTF-8");
        // 设置响应的编码集
        response.setContentType("text/html;charset=utf-8");
...
//                    获取后缀
                    ...
                    String timeStamp=simpleDateFormat.format(new Date());
                    //拼接新的文件名
                    String newName ="ZZTX"+timeStamp+sname;
                    String path = "E:\\Download\\nginx-1.22.1\\html\\upload\\zuzhi\\";
//                    File file=new File(path+fileName);
                    File file=new File(path+newName);
                    file.getParentFile().mkdirs();
                    file.createNewFile();
